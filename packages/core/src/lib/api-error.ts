...
const MESSAGE_KEY: Record<ErrorCode, MessageKey> = {
  ...
  INVALID_WEEK_START: 'error.INVALID_WEEK_START',
  ...
  CATEGORY_NAME_DUPLICATE: 'error.CATEGORY_NAME_DUPLICATE',
  ...
  TAG_MERGE_TARGET_REQUIRED: 'error.TAG_MERGE_TARGET_REQUIRED',
  TAG_MERGE_INTO_REMOVED: 'error.TAG_MERGE_INTO_REMOVED',
